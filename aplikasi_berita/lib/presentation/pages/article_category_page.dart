...
import 'package:aplikasi_berita/common/string_extensions.dart';
import 'package:aplikasi_berita/common/themes.dart';
import 'package:aplikasi_berita/presentation/bloc/article_category_bloc/article_category_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text(widget.category.toCapitalized(),
