...
import 'package:aplikasi_berita/common/themes.dart';
import 'package:aplikasi_berita/domain/entities/article.dart';
import 'package:aplikasi_berita/presentation/bloc/article_detail_bloc/article_detail_bloc.dart';
import 'package:aplikasi_berita/presentation/pages/article_webview_page.dart';
                                ...
                                GestureDetector(
                                  onTap: () => {
                                    if (!state.isAddedToBookmark)
                                      {
                                        Provider.of<ArticleDetailBloc>(context,
                                                listen: false)
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.article.title ?? 'Tidak Ada Judul',
                              ...
                              Text(
                                widget.article.author ?? 'Tidak Ada Penulis',
                                style: whiteTextStyle.copyWith(fontSize: 14),
                              ),
                            ],
                          ),
